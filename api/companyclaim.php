...
try {
    ...
    if (isset($_GET['id']) && $_GET['id'] !== '') {
        $query = "SELECT * FROM products WHERE id = :id AND claim_type = 'company_claim' LIMIT 1";
        ...
        if (!$product) {
            ...
            echo json_encode(["success" => false, "message" => "Claim product not found"]);
            exit();
        }
    ...
    $query = "SELECT * FROM products WHERE claim_type = 'company_claim'";
    $params = [];
