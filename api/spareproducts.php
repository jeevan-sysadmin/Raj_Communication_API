...
try {
    ...
    if (isset($_GET['id']) && $_GET['id'] !== '') {
        $query = "SELECT * FROM products WHERE id = :id AND is_spare_product = 1 LIMIT 1";
        ...
        if (!$product) {
            ...
            echo json_encode(["success" => false, "message" => "Spare product not found"]);
            exit();
        }
    ...
    $query = "SELECT * FROM products WHERE is_spare_product = 1";
    $params = [];
